...
log.Debug("Recorded heartbeat", "node", msg.NodeID.Hex(), "count", record.HeartbeatCount)
return nil
}
...
record.MissedCount++
log.Warn("Missed heartbeat detected", "node", addr.Hex(), "elapsed", elapsed, "missed", record.MissedCount)
}
}
}
